...
const DEFAULT_BEHIND_GRADIENT =
    'radial-gradient(farthest-side circle at var(--pointer-x) var(--pointer-y),hsla(266,100%,90%,var(--card-opacity)) 4%,hsla(266,50%,80%,calc(var(--card-opacity)*0.75)) 10%,hsla(266,25%,70%,calc(var(--card-opacity)*0.5)) 50%,hsla(266,0%,60%,0) 100%),radial-gradient(35% 52% at 55% 20%,#00ffaac4 0%,#073aff00 100%),radial-gradient(100% 100% at 50% 50%,#00c1ffff 1%,#073aff00 76%),conic-gradient(from var(--bgrotate) at 50% 50%,#c137ffff 0%,#07c6ffff 40%,#07c6ffff 60%,#c137ffff 100%)';
...
const handlePointerLeave = (event: PointerEvent) => {
  ...
  createSmoothAnimation(
      ...
      () => {
        ...
        updateCardTransform(rect.width / 2, rect.height / 2, card, wrap);
      }
  );
};
...
onMounted(() => {
  ...
  createSmoothAnimation(ANIMATION_CONFIG.INITIAL_DURATION, initialX, initialY, card, wrap, () => {
    updateCardTransform(wrap.clientWidth / 2, wrap.clientHeight / 2, card, wrap);
  });
});
...
.pc-card-wrapper::before {
  ...
  filter: contrast(1.6) saturate(1.8) blur(56px);
...
.pc-card-wrapper.active::before {
  filter: contrast(1) saturate(2) blur(72px) opacity(1);
...
.pc-card {
  ...
  background-image:
      ...
      conic-gradient(from var(--bgrotate) at 50% 50%, #c137ffff 0%, #07c6ffff 40%, #07c6ffff 60%, #c137ffff 100%);
  overflow: hidden;
}
